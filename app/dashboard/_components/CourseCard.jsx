...
function CourseCard({ course, refreshData, displayUser = false }) {
  ...
  return (
    <div className="shadow-sm rounded-lg border p-2 cursor-pointer mt-4 hover:scale-105 transition-all">
      <Link href={"/course/" + course?.courseId}>
        <Image
          src={course?.courseBanner}
          alt={course?.courseOutput?.course?.name || "Course banner"} // ✅ added alt
          width={300}
          height={200}
        ...
        {displayUser && (
          <div className="flex gap-2 items-center mt-2">
            <Image
              ...
              alt={course?.userName || "User profile"} // ✅ added alt
              width={35}
              height={35}
